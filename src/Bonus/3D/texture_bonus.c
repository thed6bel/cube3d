...
/*   Updated: 2023/09/01 14:55:46 by hucorrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port1_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port2_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port3_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port4_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port5_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port6_c.xpm"), &g->tex.door_c);
	g->tex.door_c_bak = get_anim(\
	mlx_load_img(g->mlx_ptr, "./image/animation/port7_c.xpm"), &g->tex.door_c);
}
